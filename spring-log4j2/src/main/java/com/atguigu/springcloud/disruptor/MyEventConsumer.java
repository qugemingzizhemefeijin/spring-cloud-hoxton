 ...
 */
@Slf4j
public class MyEventConsumer implements EventHandler<MyEventModel>, WorkHandler<MyEventModel> {
    ...
    public void onEvent(MyEventModel event) throws Exception {
        log.info("{} 处理了第{}条数据：{}", name, counter.incrementAndGet(), event.getData());
